...
export class BonusItems {
    constructor(game) {
        ...
        this.image.src = "../assets/Asset/ButtonAtlas/image_11.png";
        ...
        this.imagebonus0.src = '../assets/Asset/item/1.png';
        this.imagebonus1 = new Image();
        this.imagebonus1.src = '../assets/Asset/item/2.png';
        this.imagebonus2 = new Image();
        this.imagebonus2.src = '../assets/Asset/item/3.png';
        this.imagebonus3 = new Image();
        this.imagebonus3.src = '../assets/Asset/item/4.png';
        this.imagebonus4 = new Image();
        this.imagebonus4.src = '../assets/Asset/item/5.png';
        this.imagebonus5 = new Image();
        this.imagebonus5.src = '../assets/Asset/item/6.png';
    }
    update() {
    }
    draw(context) {
...
export class BoardStopGame {
    constructor(game) {
        ...
        this.staticUI = {
            board: new StaticUI(
                game,
                '../assets/Asset/PanelAtlas/image_1.png',
                0, 0,
...
export class BtnGameState {
    constructor(game) {
        ...
        this.imagePause.src = '../assets/Asset/Button/btn_pause.png';
        this.imageStart = new Image();
        this.imageStart.src = '../assets/Asset/Button/btn_start.png';
