class Button {
    ...
    draw(context) {
        context.drawImage(this.image, 0, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.spriteWidth / 2, this.spriteHeight / 2);
    }
...
export class Guide extends Button {
    ...
    draw(context) {
        ...
        context.fillText("Hướng dẫn", -this.x * 2.7 + this.spriteWidth/2, this.y + this.spriteHeight/2.5)
    }
}
