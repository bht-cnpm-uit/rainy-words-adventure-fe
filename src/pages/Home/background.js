...
export class Background {
    constructor(game) {
        ...
        this.layerImage1.image.src = '../assets/Asset/Map1/ScrollBG.png';
        this.layerImage1.image2.src = '../assets/Asset/Map1/ScrollBG.png';
        this.layerImage2 = new Layer(this.game, this.width, this.height, new Image());
        this.layerImage2.image.src = '../assets/Asset/Map1/StableBG.png';
