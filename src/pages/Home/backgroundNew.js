...
export class Background {
    constructor(game) {
        ...
        this.widthDoan = this.spriteWidthDoan * this.scaleY / 8;
        this.heightDoan = this.spriteHeightDoan * this.scaleY / 8;

        this.spriteWidthDoi = 661;
        this.spriteHeightDoi = 665;
        this.widthDoi = this.spriteWidthDoi * this.scaleY / 4.5;
        this.heightDoi = this.spriteHeightDoi * this.scaleY / 4.5;

        this.spriteWidthTruong = 313;
        this.spriteHeightTruong = 259;
        this.widthTruong = this.spriteWidthTruong * this.scaleY / 2;
        this.heightTruong = this.spriteHeightTruong * this.scaleY / 2;

        this.spriteWidthBan = 2146;
        this.spriteHeightBan = 2146;
        this.widthBan = this.spriteWidthBan * this.scaleY / 14;
        this.heightBan = this.spriteHeightBan * this.scaleY / 14;

        this.spriteWidthGame = 922;
        this.spriteHeightGame = 653;
        this.widthGame = this.spriteWidthGame * this.scaleY;
        this.heightGame = this.spriteHeightGame * this.scaleY;

        this.spriteWidthBtn = 437;
        this.spriteHeightBtn = 129;
        this.widthBtn = this.spriteWidthBtn * this.scaleY / 1.5;
        this.heightBtn = this.spriteHeightBtn * this.scaleY / 1.5;
